package com.superfunapp.pointvendor.fragments;
...
import com.superfunapp.pointvendor.HomeScreen;
import com.superfunapp.pointvendor.R;
import com.superfunapp.pointvendor.servercommunication.NetworkAvailablity;
import com.superfunapp.pointvendor.servercommunication.ServiceHandler;
import com.superfunapp.pointvendor.servercommunication.WebServiceDetails;
import com.superfunapp.pointvendor.sharedPrefrns.SharedPrefrnceSuperFun;
import com.superfunapp.pointvendor.utils.AlertDialogManager;
import com.superfunapp.pointvendor.utils.Constants;
import com.superfunapp.pointvendor.utils.Utility;
...
public class CollectFragment extends Fragment implements OnClickListener {
	...
	public class CollectTicket extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			/*System.out.println("---mob_no--"+params[0]);
			System.out.println("---branch_id--"+SharedPrefrnceSuperFun.getSharedPrefData(getActivity(), Constants.BRANCH_ID));
			System.out.println("---loc_id--"+SharedPrefrnceSuperFun.getSharedPrefData(getActivity(), Constants.COMPANY_ID));
			System.out.println("---confirmation_code--"+params[1]);
			System.out.println("---ip_address--"+Utility.getLocalIpAddress());
			System.out.println("---operation--"+"collect_point");
*/
				...
				try {
					...
					if (jsonObject != null) {
						...
						if (jsonObject.optString("status").equals("success")) {
							...
							SharedPrefrnceSuperFun.setDataInSharedPrefrence(getActivity(), Constants.TOTAL_TICKETS, jsonObject.optString("total_point"));
							
							alertDialogManager.showAlertDialog(getActivity(), "Message", "Points collected successfully");
							...
							alertDialogManager.showAlertDialog(getActivity(), "Error", "Wrong mobile number or Code");
