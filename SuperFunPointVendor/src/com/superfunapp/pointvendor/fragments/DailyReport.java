...
import com.superfunapp.pointvendor.adapters.HistoryAdapter;
...
public class DailyReport extends Fragment {
	...
	public class VendorDailyReport extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			nameValuePairs.add(new BasicNameValuePair("operation", "Collect Points"));
			...
			Log.e("VENDOR_REPORT response", json + "--" + nameValuePairs);
			
			System.out.println("-----dt----"+params[0]);
		...
		protected void onPostExecute(String result) {
			...
			if (result.length() != 0) {
				...
				try {
					...
					e.printStackTrace();
					alertDialogManager.showAlertDialog(getActivity(), "Error", "Server communication failed");
